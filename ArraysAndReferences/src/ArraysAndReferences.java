...
public final class ArraysAndReferences {
    ...
    private static NaturalNumber productOfArrayElements(
        ...
        for (int x = 0; x < nnArray.length; x++) {

            product.multiply(nnArray[x]);
        }
    ...
    private static void computePartialProducts(NaturalNumber[] nnArray) {
        ...
        for (int x = 1; x < nnArray.length; x++) {
            NaturalNumber cool = new NaturalNumber2(1);
            for (int y = 0; y <= x; y++) {

                cool.multiply(nnArray[y]);
...
//
//        for (int x=0; x<nnArray.length; x++) {
//            if( x!=0 || x!=nnArray.length) {
//            NaturalNumber storage=new NaturalNumber2();
//            storage.multiply(nnArray[x]);
//            storage.multiply(nnArray[x+1]);
//            partial[x]=
//        }
//            else {
//                NaturalNumber storage=new NaturalNumber2(nnArray[x]);
//                partial[x]
//            }
//        }
//
...
//    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < array.length; i++) {
            NaturalNumber name = new NaturalNumber2(count);
            array[i] = name;
